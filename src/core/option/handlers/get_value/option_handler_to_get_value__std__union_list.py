# //////////////////////////////////////////////////////////////////////////////
# Postgres Configuration. Implementation. Option Get Handler.
...
class OptionHandlerToGetValue__Std__UnionList(OptionHandlerToGetValue):
    def __init__(self):
        super().__init__()
    ...
    def GetOptionValue(self, ctx: OptionHandlerCtxToGetValue) -> any:
        ...
        return ctx.DataHandler.DataHandler__GetOptionValue__UnionList(
