...
from ......src.implementation.configuration_base import PostgresConfigurationComment_Base as PgCfg_Comment_Base
...
from ......src.abstract.configuration import PostgresConfigurationComment as PgCfg_Comment
...
class TestSet001__Common:
    def test_001__line_with_option(self, request: pytest.FixtureRequest):
        ...
        assert type(set_r.m_OptData) == PgCfgModel__OptionData
        assert type(set_r.m_OptData.m_Parent) == PgCfgModel__FileLineData
    ...
    def test_002__line_with_comment(self, request: pytest.FixtureRequest):
        ...
        assert type(comment1.m_CommentData) == PgCfgModel__CommentData
