...
from ......src.implementation.configuration_base import PostgresConfigurationWriter_Base as PgCfg_Writer_Base
from ......src.implementation.configuration_base import PostgresConfigurationWriterCtx_Base as PgCfg_WriterCtx_Base
...
from ......src.implementation.configuration_base import PgCfgModel__FileStatus
...
class TestSet001__Common:
    ...
    def test_001__comment_and_options(self, request: pytest.FixtureRequest):
        ...
        # LINE 0
        assert type(fileDataLines[0].m_Items[0].m_Element) == PgCfgModel__CommentData
        assert (
    ...
    def test_002__two_files(self, request: pytest.FixtureRequest):
        ...
        with open(filePath1, "x") as f:
            ...
            assert type(lastMDate1) == datetime.datetime
            f.close()
        ...
        with open(filePath2, "x") as f:
            ...
            assert type(lastMDate2) == datetime.datetime
            f.close()
