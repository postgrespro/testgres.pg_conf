...
from ......src.implementation.configuration_base import PostgresConfiguration_Base as PgCfg_Base
...
from ......src.abstract.configuration import PostgresConfiguration as PgCfg
from ......src.abstract.configuration import PostgresConfigurationFile as PgCfg_File
# fmt: on
...
class TestSet001__Common:
    ...
    def test_001(self, request: pytest.FixtureRequest, optName: str):
        ...
        assert type(set_r1) == PgCfg_SetOptionResult_Base
        assert type(set_r1.m_EventID) == PgCfg_SetOptionEventID
        assert type(set_r1.m_OptData) == PgCfgModel__OptionData
        assert type(set_r1.m_Cfg) == PgCfg_Std
        ...
        assert type(file.m_FileData.m_Lines) == list
        assert len(file.m_FileData.m_Lines) == 1
        assert type(file.m_FileData.m_Lines[0]) == PgCfgModel__FileLineData
        assert type(file.m_FileData.m_Lines[0].m_Items) == list
    ...
    def test_002__set_None(self, request: pytest.FixtureRequest, optName: str):
        ...
        assert type(set_r2) == PgCfg_SetOptionResult_Base
        assert type(set_r2.m_EventID) == PgCfg_SetOptionEventID
        ...
        assert type(set_r3) == PgCfg_SetOptionResult_Base
        assert type(set_r3.m_EventID) == PgCfg_SetOptionEventID
    ...
    def test_003__already_exist(self, request: pytest.FixtureRequest, optName: str):
        ...
        assert type(option1) == PgCfg_Option_Base
